**This repository has moved to https://code.haverbeke.berlin/codemirror/lang-rust**
...
[ [**WEBSITE**](https://codemirror.net/) | [**ISSUES**](https://code.haverbeke.berlin/codemirror/dev/issues) | [**FORUM**](https://discuss.codemirror.net/) | [**CHANGELOG**](https://code.haverbeke.berlin/codemirror/lang-rust/src/branch/main/CHANGELOG.md) ]
...
[MIT license](https://code.haverbeke.berlin/codemirror/lang-rust/tree/main/LICENSE).
...
<dd><p>A syntax provider based on the <a href="https://code.haverbeke.berlin/lezer/rust">Lezer Rust
